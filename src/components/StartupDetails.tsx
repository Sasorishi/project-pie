...
const StartupDetails: React.FC<StartupDetailsProps> = ({ startup }) => {
    ...
    const chartOptions: ApexOptions = {
        ...
        xaxis: {
            categories: ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil','Aout', 'Sept', 'Oct', 'Nov', 'Dec'],
        },
        yaxis: [{
            title: {
                text: "Financement (€)",
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div className="px-4 py-5 sm:px-6">
                        <h3 className="text-lg leading-6 font-medium text-gray-900">{startup.name}</h3>
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">Détails de performance et de croissance.</p>
                    </div>
                    <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div className="py-2">
                                    <dt className="text-sm font-medium text-gray-500">Positionnement sur le marché</dt>
                                    <dd className="mt-1 text-sm text-gray-900">{getMarketPositioningIcon(startup.marketPositioning)}</dd>
                                </div>
                                <div className="py-2">
                            ...
                            <div>
                                ...
                                <div className="py-2">
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900">{startup.legalStatus}</dd>
                                </div>
                                <div className="py-2">
                                    <dt className="text-sm font-medium text-gray-500">Date de Création</dt>
                                    <dd className="mt-1 text-sm text-gray-900">{startup.creationDate}</dd>
                                </div>
                                <div className="py-2">
                                    <dt className="text-sm font-medium text-gray-500">Capital Social</dt>
                                    <dd className="mt-1 text-sm text-gray-900">{startup.shareCapital.toLocaleString()} €</dd>
                                </div>
                                <div className="py-2">
                                    <dt className="text-sm font-medium text-gray-500">Taille</dt>
                                    <dd className="mt-1 text-sm text-gray-900">{startup.size} employés</dd>
                                </div>
                            </div>
                        </div>
                    </div>
