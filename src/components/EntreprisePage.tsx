...
const entreprises = [
  {
    ...
    size: 50,
    growthData: {
      funding: [300000, 250000, 200000, 350000, 400000, 250000, 300000, 250000, 200000, 350000, 400000, 250000],
      revenue: [150000, 200000, 250000, 300000, 350000, 300000, 250000, 200000, 250000, 300000, 350000, 300000]
    }
  },
  {
    id: "2",
    ...
    size: 30,
    growthData: {
      funding: [100000, 150000, 200000, 250000, 300000, 150000, 100000, 150000, 200000, 250000, 300000, 150000],
      revenue: [50000, 100000, 150000, 200000, 250000, 200000, 150000, 100000, 150000, 200000, 250000, 200000]
    }
  },
  {
    id: "3",
    ...
    size: 70,
    growthData: {
      funding: [200000, 250000, 300000, 350000, 400000, 350000, 300000, 250000, 200000, 250000, 300000, 350000],
      revenue: [100000, 150000, 200000, 250000, 300000, 250000, 200000, 150000, 100000, 150000, 200000, 250000]
    }
  }
];

const calculateShareCapital = (growthData: any) => {
  const totalFunding = growthData.funding.reduce((acc: any, val: any) => acc + val, 0);
  const totalRevenue = growthData.revenue.reduce((acc: any, val: any) => acc + val, 0);
